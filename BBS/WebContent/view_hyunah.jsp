...
<body>
	<%  //로그인이 된 사람들은, 로그인이 된 정보를 담을 수 있도록 함
		String userID = null;
		...
		if (request.getParameter("bbsID") != null) { // bbsID라는 매개변수가 존재한다면 
			bbsID = Integer.parseInt(request.getParameter("bbsID"));  // bbsID가 넘어옴
		}
		if (bbsID == 0) {
	...
	<nav class="navbar navbar-default">
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			...
			<%  
				//접속하기는 로그인이 되어있지 않은 사람들에게만 보이게 해야함.
				if(userID == null) {
			%>
	...
	<div class="container">
		<div class="row">
			...
			<%
				// 해당 글의 작성자가 본인이라면, 글을 수정ㆍ삭제 할 수 있음
